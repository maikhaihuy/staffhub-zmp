...
export function EvidenceUpload({ photos, onAdd, onRemove, onOpenCamera, canAdd }: EvidenceUploadProps) {
  ...
  return (
    <section aria-label="Evidence photos">
        ...
        <div className="upload-zone">
          {photos.length === 0 && (
            <div className="upload-empty">
              ...
              <span className="upload-empty__title">No photos yet</span>
              <span className="upload-empty__sub">Cleaned bar · inventory · customer area</span>
            </div>
          )}
